    ...
    <form action="Registration" method="post">
    			<table>
    				...
    				<tr>
    					...
    					<tr>
    					<td>Password</td>
    					<td><input type="password" name="password" required pattern="((?=.*\d)(?=.*[0-9])(?=.*[A-Z])(?=.*[a-z])(?=.*[!@#$%^&*]).{6,20})" title="must contain atleast 1-UpperCase,1-LowerCase,1-specialCharacter And 1-Digit"/></td>
    				</tr>
    				</table>
